...
def gnomonMeshInput(attr, method=None, setter_method=None, data_plugin=default_plugin, data_setter=default_setter, data_attr=default_attr):
    def wrapper(cls):
...
def gnomonMeshOutput(attr, method=None, data_plugin=default_plugin, data_setter=default_setter):
    def wrapper(cls):
        if method is None:
