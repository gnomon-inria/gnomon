...
def treeInput(attr, data_plugin, methods=(None, None)):
    """
    Implements the accessor methods to attr for a tree input.
    Those accessors will convert between a gnomonTree and the type
...
def treeOutput(attr, data_plugin, method=None):
    """
    Implements the getter method to attr for a tree output.
    This getter will convert between a gnomonTree and the type
    of attr as defined by the data_plugin.
