...
class GNOMONWIDGETS_EXPORT gnomonClutEditorVertex : public QObject, public QGraphicsItem
{
    Q_OBJECT
...
class GNOMONWIDGETS_EXPORT gnomonClutEditorScene : public QGraphicsScene
{
    Q_OBJECT
...
class GNOMONWIDGETS_EXPORT gnomonClutEditorView : public QGraphicsView
{
public:
...
class GNOMONWIDGETS_EXPORT gnomonClutEditor : public QWidget
{
    Q_OBJECT
