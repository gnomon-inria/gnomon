...
// ///////////////////////////////////////////////////////////////////
// tissueFontAwesomeIconPainter
// ///////////////////////////////////////////////////////////////////

class tissueFontAwesomeIconPainter;

// ///////////////////////////////////////////////////////////////////
// tissueFontAwesome
// ///////////////////////////////////////////////////////////////////

class tissueFontAwesome : public QObject
{
    Q_OBJECT

public:
    explicit tissueFontAwesome(QObject *parent = 0);
    virtual ~tissueFontAwesome(void);

public:
    void init(const QString& fontname);
    bool initFontAwesome(void);

    void addNamedCodepoint(const QString& name, int codePoint);

    QHash<QString,int> namedCodePoints(void) { return namedCodepoints_; }
    ...
    QIcon icon(tissueFontAwesomeIconPainter *painter, const QVariantMap& optionMap = QVariantMap());

    void give(const QString& name, tissueFontAwesomeIconPainter *painter);
...
private:
    ...
    QHash<QString, tissueFontAwesomeIconPainter*> painterMap_;
    QVariantMap defaultOptions_;
    tissueFontAwesomeIconPainter* fontIconPainter_;
};
...
{
public:
    virtual ~tissueFontAwesomeIconPainter(void) {}

public:
    virtual void paint(tissueFontAwesome *awesome, QPainter *painter, const QRect& rect, QIcon::Mode mode, QIcon::State state, const QVariantMap& options) = 0;
};

//
// tissueFontAwesome.h ends here
