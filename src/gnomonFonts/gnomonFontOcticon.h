...
// ///////////////////////////////////////////////////////////////////
// gnomonFontOcticonsIconPainter
// ///////////////////////////////////////////////////////////////////

class gnomonFontOcticonsIconPainter;

// ///////////////////////////////////////////////////////////////////
// gnomonFontOcticons
// ///////////////////////////////////////////////////////////////////

class gnomonFontOcticons : public QObject
{
    Q_OBJECT

public:
    explicit gnomonFontOcticons(QObject *parent = 0);
    virtual ~gnomonFontOcticons(void);
...
public:
    ...
    QIcon icon(gnomonFontOcticonsIconPainter *painter, const QVariantMap& optionMap = QVariantMap());

    void give(const QString& name, gnomonFontOcticonsIconPainter *painter);
...
private:
    QString fontName_;
    QHash<QString, gnomonFontOcticonsIconPainter*> painterMap_;
    QVariantMap defaultOptions_;
    gnomonFontOcticonsIconPainter* fontIconPainter_;
};
...
{
public:
    virtual ~gnomonFontOcticonsIconPainter(void) {}

public:
    virtual void paint(gnomonFontOcticons *awesome, QPainter *painter, const QRect& rect, QIcon::Mode mode, QIcon::State state, const QVariantMap& options) = 0;
};

//
// gnomonFontOcticonsIcons.h ends here
