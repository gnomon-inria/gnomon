...
#include "gnomonFontAwesome.h"

// ///////////////////////////////////////////////////////////////////
// gnomonFontAwesomeCharIconPainter
// ///////////////////////////////////////////////////////////////////

class gnomonFontAwesomeCharIconPainter: public gnomonFontAwesomeIconPainter
{
public:
    virtual void paint(gnomonFontAwesome *awesome, QPainter *painter, const QRect& rect, QIcon::Mode mode, QIcon::State state, const QVariantMap& options)
    {
        Q_UNUSED(mode);
        Q_UNUSED(state);
        Q_UNUSED(options);
...
// ///////////////////////////////////////////////////////////////////
// gnomonFontAwesomeIconPainterIconEngine
// ///////////////////////////////////////////////////////////////////

class gnomonFontAwesomeIconPainterIconEngine : public QIconEngine
{
public:
    gnomonFontAwesomeIconPainterIconEngine(gnomonFontAwesome *awesome, gnomonFontAwesomeIconPainter *painter, const QVariantMap& options)
        : awesomeRef_(awesome)
    ...
    virtual ~gnomonFontAwesomeIconPainterIconEngine(void) {}

    gnomonFontAwesomeIconPainterIconEngine *clone(void) const
    {
        return new gnomonFontAwesomeIconPainterIconEngine(awesomeRef_, iconPainterRef_, options_);
    }
...
private:
    gnomonFontAwesome *awesomeRef_;
    gnomonFontAwesomeIconPainter *iconPainterRef_;
...
gnomonFontAwesome::gnomonFontAwesome(QObject *parent)
    : QObject(parent)
    , namedCodepoints_()
{
    ...
    fontIconPainter_ = new gnomonFontAwesomeCharIconPainter();
}

gnomonFontAwesome::~gnomonFontAwesome(void)
{
    delete fontIconPainter_;
    qDeleteAll(painterMap_);
}

void gnomonFontAwesome::init(const QString& fontname)
{
    fontName_ = fontname;
}
...
bool gnomonFontAwesome::initFontAwesome()
{
    static int fontAwesomeFontId = -1;

    if(fontAwesomeFontId < 0) {

        QFile res(":gnomonFontAwesome.ttf");
...
void gnomonFontAwesome::addNamedCodepoint(const QString& name, int codePoint)
{
    namedCodepoints_.insert(name, codePoint);
}


void gnomonFontAwesome::setDefaultOption(const QString& name, const QVariant& value)
{
    defaultOptions_.insert(name, value);
}

QVariant gnomonFontAwesome::defaultOption(const QString& name)
{
...
QIcon gnomonFontAwesome::icon(int character, const QVariantMap &options)
{
...
QIcon gnomonFontAwesome::icon(const QString& name, const QVariantMap& options)
{
    ...
    gnomonFontAwesomeIconPainter *painter = painterMap_.value(name);
...
QIcon gnomonFontAwesome::icon(gnomonFontAwesomeIconPainter *painter, const QVariantMap& optionMap)
{
    gnomonFontAwesomeIconPainterIconEngine *engine = new gnomonFontAwesomeIconPainterIconEngine(this, painter, optionMap);

    return QIcon(engine);
}

void gnomonFontAwesome::give(const QString& name, gnomonFontAwesomeIconPainter *painter)
{
...
QFont gnomonFontAwesome::font(int size)
{
...
//
// gnomonFontAwesome.cpp ends here
