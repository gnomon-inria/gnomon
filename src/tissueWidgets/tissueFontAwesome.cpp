...
#include "tissueFontAwesome.h"

// ///////////////////////////////////////////////////////////////////
// tissueFontAwesomeCharIconPainter
// ///////////////////////////////////////////////////////////////////

class tissueFontAwesomeCharIconPainter: public tissueFontAwesomeIconPainter
{
public:
    virtual void paint(tissueFontAwesome *awesome, QPainter *painter, const QRect& rect, QIcon::Mode mode, QIcon::State state, const QVariantMap& options)
    {
        Q_UNUSED(mode);
        Q_UNUSED(state);
        Q_UNUSED(options);
...
// ///////////////////////////////////////////////////////////////////
// tissueFontAwesomeIconPainterIconEngine
// ///////////////////////////////////////////////////////////////////

class tissueFontAwesomeIconPainterIconEngine : public QIconEngine
{
public:
    tissueFontAwesomeIconPainterIconEngine(tissueFontAwesome *awesome, tissueFontAwesomeIconPainter *painter, const QVariantMap& options)
        : awesomeRef_(awesome)
    ...
    virtual ~tissueFontAwesomeIconPainterIconEngine(void) {}

    tissueFontAwesomeIconPainterIconEngine *clone(void) const
    {
        return new tissueFontAwesomeIconPainterIconEngine(awesomeRef_, iconPainterRef_, options_);
    }
...
private:
    tissueFontAwesome *awesomeRef_;
    tissueFontAwesomeIconPainter *iconPainterRef_;
...
tissueFontAwesome::tissueFontAwesome(QObject *parent)
    : QObject(parent)
    , namedCodepoints_()
{
    ...
    fontIconPainter_ = new tissueFontAwesomeCharIconPainter();
}

tissueFontAwesome::~tissueFontAwesome(void)
{
    delete fontIconPainter_;
    qDeleteAll(painterMap_);
}

void tissueFontAwesome::init(const QString& fontname)
{
    fontName_ = fontname;
}
...
bool tissueFontAwesome::initFontAwesome()
{
    static int fontAwesomeFontId = -1;

    if(fontAwesomeFontId < 0) {

        QFile res(":tissueFontAwesome.ttf");
...
void tissueFontAwesome::addNamedCodepoint(const QString& name, int codePoint)
{
    namedCodepoints_.insert(name, codePoint);
}


void tissueFontAwesome::setDefaultOption(const QString& name, const QVariant& value)
{
    defaultOptions_.insert(name, value);
}

QVariant tissueFontAwesome::defaultOption(const QString& name)
{
...
QIcon tissueFontAwesome::icon(int character, const QVariantMap &options)
{
...
QIcon tissueFontAwesome::icon(const QString& name, const QVariantMap& options)
{
    ...
    tissueFontAwesomeIconPainter *painter = painterMap_.value(name);
...
QIcon tissueFontAwesome::icon(tissueFontAwesomeIconPainter *painter, const QVariantMap& optionMap)
{
    tissueFontAwesomeIconPainterIconEngine *engine = new tissueFontAwesomeIconPainterIconEngine(this, painter, optionMap);

    return QIcon(engine);
}

void tissueFontAwesome::give(const QString& name, tissueFontAwesomeIconPainter *painter)
{
...
QFont tissueFontAwesome::font(int size)
{
...
//
// tissueFontAwesome.cpp ends here
