...
public:
    ...
    tissueCodeEditorSyntaxHighlighter *highlighter;
...
tissueCodeEditor::tissueCodeEditor(QWidget *parent) : QPlainTextEdit(parent)
{
    d = new tissueCodeEditorPrivate;

    d->line_number_area = new tissueCodeEditorLineNumberArea(this);
    ...
    d->highlighter = new tissueCodeEditorSyntaxHighlighter(document());
...
QString tissueCodeEditor::textUnderCursor(void)
{
...
void tissueCodeEditor::insertCompletion(QString completion)
{
    QTextCursor tc = textCursor();
...
void tissueCodeEditor::keyPressEvent(QKeyEvent *e)
{
...
tissueCodeEditor::~tissueCodeEditor(void)
{
    delete d;
}

void tissueCodeEditor::updateVocabulary(void)
{
...
int tissueCodeEditor::lineNumberAreaWidth(void)
{
    int digits = 1;
...
void tissueCodeEditor::updateLineNumberAreaWidth(int)
{
    setViewportMargins(lineNumberAreaWidth(), 0, 0, 0);
}

void tissueCodeEditor::updateLineNumberArea(const QRect &rect, int dy)
{
    if (dy) {
...
void tissueCodeEditor::resizeEvent(QResizeEvent *e)
{
...
void tissueCodeEditor::highlightCurrentLine(void)
{
...
void tissueCodeEditor::lineNumberAreaPaintEvent(QPaintEvent *event)
{
...
tissueCodeEditorSyntaxHighlighter::tissueCodeEditorSyntaxHighlighter(QTextDocument* document) : QSyntaxHighlighter(document)
{
    d = new tissueCodeEditorSyntaxHighlighterPrivate;
...
tissueCodeEditorSyntaxHighlighter::~tissueCodeEditorSyntaxHighlighter(void)
{
    delete d;
}

void tissueCodeEditorSyntaxHighlighter::highlightBlock(const QString& text)
{
...
//
// tissueCoreEditor.cpp ends here
