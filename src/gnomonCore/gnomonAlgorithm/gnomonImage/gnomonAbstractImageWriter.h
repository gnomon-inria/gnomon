...
GNOMON_DECLARE_PLUGIN_FACTORY(gnomonAbstractImageWriter, GNOMONCORE_EXPORT)
...
namespace gnomonCore {
    GNOMON_DECLARE_CONCEPT(gnomonAbstractImageWriter, GNOMONCORE_EXPORT, imageWriter);
}
