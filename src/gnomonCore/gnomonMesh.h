...
public:
    ...
    virtual long addTriangle(QList<long> vertexIds) { return m_data->addTriangle(vertexIds); }
    virtual long addTriangle(QList<long> vertexIds, long triangleId) { return m_data->addTriangle(vertexIds, triangleId); }
...
public:
    ...
    virtual const QMap<long, QVariant>& triangleProperty(const QString& propertyName) const { return m_data->triangleProperty(propertyName); }
    virtual       QMap<long, QVariant>& triangleProperty(const QString& propertyName) { return m_data->triangleProperty(propertyName); }
