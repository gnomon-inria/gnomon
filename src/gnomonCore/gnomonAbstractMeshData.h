...
public:
    ...
    virtual long addTriangle(QList<long> vertexIds) = 0;
    virtual long addTriangle(QList<long> vertexIds, long triangleId) = 0;
...
//  ///////////////////////////////////////////////////////////////////
    ...
    virtual const QMap<long, QVariant>& triangleProperty(const QString& propertyName) const = 0;
    virtual       QMap<long, QVariant>& triangleProperty(const QString& propertyName) = 0;
