...
/*
 * Code autocompletion and line numbering are derived from Qt examples.
 *
...
/*
 * The list of python keywords and builtins is stored as a static array.
 * A cleaner method would be to put this list in a resource.
 * The list will be read periodically.
 * */
...
void tissueGrowthSimulatorCodeEditor::enableAutocompletion(bool enabled)
{
...
QString tissueGrowthSimulatorCodeEditor::textUnderCursor()
{
...
void tissueGrowthSimulatorCodeEditor::insertCompletion(QString completion)
{
    QTextCursor tc = textCursor();
...
void tissueGrowthSimulatorCodeEditor::keyPressEvent(QKeyEvent *e)
{
