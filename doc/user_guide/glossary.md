...
A **Pipeline** is a graph composed of *Nodes* that represent [**Algorithms**](algorithm-definition) and directed *Edges* corresponding to [**Forms**](form-definition). 
...
A **Session** is the result of the interaction of a user with the Gnomon application after opening a [**Project**](project-definition). The state of the Session includes all the [**Forms**](form-definition), [**Workspaces**](workspace-definition) and the subsequent [**Pipeline**](pipeline-definition) that have been generated by the user.
:::
