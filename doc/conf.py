...
src_dir = os.path.abspath(os.path.join(project_root, "python"))
...
latex_documents = [
    (master_doc, 'Gnomon.tex', 'Gnomon Documentation',
     'Nicolas Niclausse', 'manual'),
]
...
man_pages = [
    (master_doc, 'gnomon', 'Gnomon Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Gnomon', 'Gnomon Documentation',
     author, 'Gnomon', 'One line description of project.',
     'Miscellaneous'),
]
