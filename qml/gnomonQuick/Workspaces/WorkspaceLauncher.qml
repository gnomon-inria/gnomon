...
G.Workspace {
    ...
    G.Dialog {
        ...
        Label {
            text: _workspace._blank_session ? "Are you sure to start blank session ?\n(Delete session, You will lost data generated by the project)" :
                                              "Reinitialize project settings ? \n(Delete session, Reset parameters, \nYou will lost data generated by the project and data paths) "
